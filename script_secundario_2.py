        ...
        try:
            while 1:
                ...
                for i in range(len(li_elements)):
                    ...
                    for attr in talla.get_property('attributes'):
                        # Si el atributo es 'data-size' y su valor es el que queremos
                        if attr['name'] == 'data-size' and attr['value'] == talla_elegida:
                            # Se guarda el atributo <class> que indica
